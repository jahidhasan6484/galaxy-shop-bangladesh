...
const ProductCard = (props) => {
    const { id, name, photo, category, previousPrice, price } = props.product;
    return (
        <div class="col-md-3">
            <div class="card mb-5">
                ...
                <div class="card-body">
                    ...
                    <div className="d-flex justify-content-around buttons">
                        <div>
                            <Link to=""><img className="img-fluid cardButton" src={wishlist}></img></Link>
                        </div>
                        <div>
                            <Link to={`/singleProduct/${id}`}><img className="img-fluid cardButton" src={details}></img></Link>
                        </div>
                        <div>
                            <Link to=""><img className="img-fluid cardButton" src={cart}></img></Link>
                        </div>
                    </div>
                </div>
            </div>
